 ...
 */
@Component
public class ApiInterfaceTask implements IServiceTask {
    /**
     * 常量
     */
    ...
    @Override
    public ServiceType getType() { return new ServiceType("第三方接口任务", "apiInterfaceTask"); }
    ...
    public void handle(DelegateExecution execution, String setting) {
        ...
        String interfaceId=jsonObject.getString("interface");
        String apiDataType=jsonObject.getString("apiDataType");
        JSONObject paramsData=jsonObject.getJSONObject("params");
        ...
        try {
            ...
            if (MBoolean.TRUE_LOWER.val.equals(async)) {
                ...
                eventConfig.setHanderType("apiInterface");
