...
@Slf4j
@RestController
@RequestMapping("/bpm/core/appdata")
@ClassDefine(title = "应用数据处理",alias = "AppDataController",path = "/bpm/core/appdata",packages = "core",packageName = "流程管理")
@Api(tags = "应用数据处理")
public class AppDataController {
    ...
    public JsonResult install(@ApiParam @RequestBody  String data){
        try {
            ...
            return JsonResult.Fail("导入应用流程数据失败：" + e.getMessage());
        }
    }
}
