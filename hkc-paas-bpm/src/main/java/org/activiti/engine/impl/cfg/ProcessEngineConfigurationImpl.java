        ...
        if (sqlSessionFactory == null) {
            ...
            try {
                ...
                if (databaseType != null) {
                    ...
                    if("dm".equalsIgnoreCase(type) || DATABASE_TYPE_KINGBASE.equals(type)){
                        type="oracle";
                    }
                    properties.load(getResourceAsStream("org/activiti/db/properties/"+type+".properties"));
                }
...
//                type="oracle";
//            }
            configuration.setDatabaseId(type);
        }
    ...
    public int getMaxLengthString() {
        if (maxLengthStringVariableType == -1) {
            if ("oracle".equalsIgnoreCase(databaseType) || "dm".equalsIgnoreCase(databaseType)) {
