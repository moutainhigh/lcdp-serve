	    ...
	    <section class="content">
	    	...
	    	<div>
                ...
                <div style="width: 80px;float: left">
                    <div class="input-group">
                        <select class="form-control" style="border-radius: 5px" id="triggerStatus" >
                ...
                <div class="col-xs-2" style="width: 170px">
                    <div class="input-group">
                        <input type="text" class="form-control borde" id="jobDesc" autocomplete="on" placeholder="${I18n.system_please_input}${I18n.jobinfo_field_jobdesc}" >
                    </div>
                </div>
                <div class="col-xs-2" style="width: 170px">
                    <div class="input-group">
                        <input type="text" class="form-control borde" id="executorHandler" autocomplete="on" placeholder="${I18n.system_please_input}JobHandler" >
                    </div>
                </div>
                <div class="col-xs-2" style="width: 170px">
                    <div class="input-group">
                        <input type="text" class="form-control borde" id="author" autocomplete="on" placeholder="${I18n.system_please_input}${I18n.jobinfo_field_author}" >
                    </div>
                </div>
	            <div class="col-xs-1">
...
<!-- DataTables -->
<script src="${request.contextPath}/static/adminlte/bower_components/datatables.net/js/jquery.dataTables.min.js?v=37"></script>
<script src="${request.contextPath}/static/adminlte/bower_components/datatables.net-bs/js/dataTables.bootstrap.min.js?v=37"></script>
<!-- moment -->
<script src="${request.contextPath}/static/adminlte/bower_components/moment/moment.min.js?v=37"></script>
<#-- cronGen -->
<script src="${request.contextPath}/static/plugins/cronGen/cronGen<#if I18n.admin_i18n?default('')?length gt 0 >_${I18n.admin_i18n}</#if>.js?v=37"></script>
<script src="${request.contextPath}/static/js/jobinfo.index.1.js?v=37"></script>
</body>
</html>
