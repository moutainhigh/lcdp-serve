 ...
 * <pre>
 *     1.第一级为应用。
 *          menu_id_ 和 app_id_ 相同，父ID 为 0
 *     2.第一级菜单
 *          parent_id_ 和 app_id_ 保持一致。
 *
 * </pre>
 */
@Setter
...
@TableName(value = "OS_GROUP_MENU")
public class OsGroupMenu  extends BaseExtEntity<String> {
