...
import com.redxun.portal.core.service.AppDataServiceImpl;
 ...
 * @Author: Elwin ZHANG
 * @Date: 2021/6/25 16:09
 **/
@Slf4j
@RestController
@RequestMapping("/portal/core/appdata")
@ClassDefine(title = "应用数据处理",alias = "AppDataController",path = "/portal/core/appdata",packages = "core",packageName = "门户管理")
@Api(tags = "应用数据处理")
public class AppDataController {
    ...
    public JsonResult install(@ApiParam @RequestBody  String data){
        try {
            ...
            return JsonResult.Fail("导入应用门户数据失败：" + e.getMessage());
        }
    }
}
