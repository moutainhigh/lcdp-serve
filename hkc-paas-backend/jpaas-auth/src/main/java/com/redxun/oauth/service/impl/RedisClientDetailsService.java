...
public class RedisClientDetailsService implements ClientDetailsService {
    ...
    public ClientDetails loadClientByClientId(String clientId) {
        ...
        ClientDetails clientDetails = SecurityUtil.getClient(appProperties.getClientId(),appProperties.getClientSecret());
    ...
    public void loadAllClientToCache() {
        /*boolean flag = remoteClientService.getAllClients();
        if (!flag) {
