...
@Service
@Slf4j
public class WeiXinEntQCodeSocialHandler implements ISocialHandler {
    ...
    public JsonResult handAuthUrl(String tenantId, String redirectUrl, String state) {
        ...
        String authUrl = wxEntUtil.getQRConnectUrl(osWxEntAgentDto.getCorpId(),osWxEntAgentDto.getAgentId(), redirectUrl);
