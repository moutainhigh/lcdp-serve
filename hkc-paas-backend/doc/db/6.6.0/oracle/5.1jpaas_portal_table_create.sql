...
COMMENT ON COLUMN INF_INBOX.DELETED_ IS
'逻辑删除';

COMMENT ON COLUMN INF_INBOX.COMPANY_ID_ IS
'公司ID';
...
COMMENT ON COLUMN INF_INNER_MSG.DELETED_ IS
'逻辑删除';

COMMENT ON COLUMN INF_INNER_MSG.COMPANY_ID_ IS
'公司ID';
...
COMMENT ON COLUMN INF_INNER_MSG_LOG.DELETED_ IS
'逻辑删除';

COMMENT ON COLUMN INF_INNER_MSG_LOG.COMPANY_ID_ IS
'公司ID';
...
COMMENT ON COLUMN INS_APP_COLLECT.APP_ IS
'内部应用';

COMMENT ON COLUMN INS_APP_COLLECT.APP_TYPE_ IS
'应用类型(DEFAULT、CUSTOM)';

COMMENT ON COLUMN INS_APP_COLLECT.DELETED_ IS
'逻辑删除';

COMMENT ON COLUMN INS_APP_COLLECT.COMPANY_ID_ IS
'公司ID';
...
COMMENT ON COLUMN INS_COLUMN_DEF.DELETED_ IS
'逻辑删除';

COMMENT ON COLUMN INS_COLUMN_DEF.COMPANY_ID_ IS
'公司ID';
...
COMMENT ON COLUMN INS_COLUMN_TEMP.DELETED_ IS
'逻辑删除';

COMMENT ON COLUMN INS_COLUMN_TEMP.COMPANY_ID_ IS
'公司ID';
...
COMMENT ON COLUMN INS_MSGBOX_BOX_DEF.DELETED_ IS
'逻辑删除';

COMMENT ON COLUMN INS_MSGBOX_BOX_DEF.COMPANY_ID_ IS
'公司ID';
...
COMMENT ON COLUMN INS_MSGBOX_DEF.DELETED_ IS
'逻辑删除';

COMMENT ON COLUMN INS_MSGBOX_DEF.COMPANY_ID_ IS
'公司ID';
...
COMMENT ON COLUMN INS_MSG_DEF.DELETED_ IS
'逻辑删除';

COMMENT ON COLUMN INS_MSG_DEF.COMPANY_ID_ IS
'公司ID';
...
COMMENT ON COLUMN INS_NEWS.DELETED_ IS
'逻辑删除';

COMMENT ON COLUMN INS_NEWS.COMPANY_ID_ IS
'公司ID';
...
COMMENT ON COLUMN INS_PORTAL_DEF.DELETED_ IS
'逻辑删除';

COMMENT ON COLUMN INS_PORTAL_DEF.COMPANY_ID_ IS
'公司ID';
...
COMMENT ON COLUMN INS_PORTAL_PERMISSION.DELETED_ IS
'逻辑删除';

COMMENT ON COLUMN INS_PORTAL_PERMISSION.COMPANY_ID_ IS
'公司ID';
...
COMMENT ON COLUMN INS_REMIND_DEF.DELETED_ IS
'逻辑删除';

COMMENT ON COLUMN INS_REMIND_DEF.COMPANY_ID_ IS
'公司ID';
