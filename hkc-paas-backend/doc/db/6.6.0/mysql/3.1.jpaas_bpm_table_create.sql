...
/*==============================================================*/
/* DBMS name:      MySQL 5.0                                    */
/* Created on:     2022-08-03 13:55:39                          */
/*==============================================================*/
...
ALTER TABLE BPM_AUTH COMMENT '流程授权表';
...
(
   ...
   HANDLER_USERNAME_    VARCHAR(64) COMMENT '处理人名称',
...
(
   ID_                  VARCHAR(64) NOT NULL COMMENT '主键',
   TEMPLATE_TYPE_       VARCHAR(64) COMMENT '模板类型',
   MESSAGE_TYPE_        VARCHAR(64) COMMENT '消息类型',
...
ALTER TABLE BPM_DEFAULT_TEMPLATE COMMENT '流程默认消息模板';
...
(
   ID_                  VARCHAR(64) NOT NULL COMMENT '主键',
   DELIVER_USER_ID_     VARCHAR(64) COMMENT '移交人ID',
   DELIVER_USER_NO_     VARCHAR(64) COMMENT '移交人工号',
   DELIVER_USER_NAME_   VARCHAR(64) COMMENT '移交人',
   RECEIPT_USER_ID_     VARCHAR(64) COMMENT '接管人ID',
   RECEIPT_USER_NO_     VARCHAR(64) COMMENT '接管人工号',
   RECEIPT_USER_NAME_   VARCHAR(64) COMMENT '接管人',
...
ALTER TABLE BPM_DELIVER COMMENT '流程待办任务交接';
...
ALTER TABLE BPM_DELIVER_LOG COMMENT '流程待办任务交接日志';
...
(
   ...
   PARENT_ACT_INST_ID_  VARCHAR(64) COMMENT '父ACT流程实例ID',
   DELETED_             INT DEFAULT 0 COMMENT '逻辑删除',
   COMPANY_ID_          VARCHAR(30) COMMENT '公司ID',
   TENANT_ID_           VARCHAR(64) COMMENT '租用用户Id',
   CREATE_DEP_ID_       VARCHAR(64) COMMENT '创建部门ID',
...
(
   ...
   CREATE_BY_           VARCHAR(64) COMMENT '创建人ID',
   CREATE_TIME_         DATETIME COMMENT '创建时间',
   IDUPDATE_BY_         VARCHAR(64) COMMENT '更新人',
   UPDATE_TIME_         DATETIME COMMENT '更新时间',
   APP_ID_              VARCHAR(64) COMMENT '应用ID',
   COMPANY_ID_          VARCHAR(64) COMMENT '所属公司ID',
   PRIMARY KEY (ID_)
...
ALTER TABLE BPM_INST_PERMISSION COMMENT '流程实例权限表';
...
ALTER TABLE BPM_INST_TRACKED COMMENT '流程实例跟踪';
...
(
   ...
   NODE_ID_             VARCHAR(64) COMMENT '节点ID',
   BO_ALIAS_            VARCHAR(64) COMMENT 'BO定义别名',
...
ALTER TABLE BPM_MESSAGE_TEMPLATE COMMENT '流程消息模板';
...
(
   ID_                  VARCHAR(64) NOT NULL COMMENT '主键',
   QUIT_USER_ID_        VARCHAR(64) COMMENT '离职人员ID',
   QUIT_USER_NO_        VARCHAR(64) COMMENT '离职人员工号',
   QUIT_USER_NAME_      VARCHAR(64) COMMENT '离职人员',
   DEF_ID_              VARCHAR(64) COMMENT '流程定义ID',
   DEF_NAME_            VARCHAR(255) COMMENT '流程定义标题',
   NODE_ID_             VARCHAR(64) COMMENT '流程节点ID',
   NODE_NAME_           VARCHAR(100) COMMENT '流程节点名称',
   DELETED_             INT DEFAULT 0 COMMENT '逻辑删除',
   COMPANY_ID_          VARCHAR(30) COMMENT '公司ID',
   TENANT_ID_           VARCHAR(64) COMMENT '租用用户Id',
   CREATE_DEP_ID_       VARCHAR(64) COMMENT '创建部门ID',
...
ALTER TABLE BPM_QUIT_USER_TASK COMMENT '离职人员流程任务表';
