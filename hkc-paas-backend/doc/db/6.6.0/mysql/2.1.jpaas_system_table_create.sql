...
(
   ID_                  VARCHAR(64) NOT NULL COMMENT '主键',
   SERVICE_             VARCHAR(64) COMMENT '所属服务',
   API_NAME_            VARCHAR(64) COMMENT 'API接口名称',
...
(
   ...
   FAV_TIME_            DATETIME DEFAULT NULL COMMENT '收藏时间',
   LAST_USE_TIME_       DATETIME DEFAULT NULL COMMENT '最近使用时间',
   DELETED_             INT DEFAULT 0 COMMENT '逻辑删除',
   COMPANY_ID_          VARCHAR(30) COMMENT '公司ID',
   TENANT_ID_           VARCHAR(64) DEFAULT NULL COMMENT '租户Id',
   CREATE_DEP_ID_       VARCHAR(64) DEFAULT NULL COMMENT '创建部门ID',
...
(
   ID_                  VARCHAR(64) NOT NULL COMMENT '主键',
   APP_ID_              VARCHAR(64) NOT NULL COMMENT '应用ID',
   AUTH_TYPE_           SMALLINT(6) NOT NULL DEFAULT 1 COMMENT '1开发权限2管理权限',
...
ALTER TABLE SYS_APP_MANAGER COMMENT '平台开发应用授权管理';
...
(
   ID_                  VARCHAR(64) NOT NULL COMMENT '主键',
   TREE_ID_             VARCHAR(40) COMMENT '分类ID',
   TREE_NAME_           VARCHAR(64) COMMENT '分类名称',
...
(
   ...
   METHOD_              VARCHAR(20) COMMENT '请求方法',
   PARAMS_              TEXT COMMENT '请求参数',
   HEADERS_             VARCHAR(4000) COMMENT '请求头',
   BODY_                TEXT COMMENT '请求体',
   TYPE_                VARCHAR(64) COMMENT '类型',
   CREATE_DEP_ID_       VARCHAR(64) COMMENT '创建部门ID',
   DELETED_             INT DEFAULT 0 COMMENT '逻辑删除',
   COMPANY_ID_          VARCHAR(30) COMMENT '公司ID',
...
ALTER TABLE SYS_EXTERNAL_API COMMENT '对外API接口管理';
...
(
   ID_                  VARCHAR(64) NOT NULL COMMENT '主键',
   TYPE_                VARCHAR(40) NOT NULL COMMENT '类型',
   REL_ID_              VARCHAR(64) COMMENT '关联ID',
   REL_NAME_            VARCHAR(128) COMMENT '关联名称',
   BEAN_NAME_           VARCHAR(128) COMMENT '类名',
   METHOD_              VARCHAR(64) COMMENT '方法名',
   PARAMS_              TEXT COMMENT '方法参数',
   STATUS_              VARCHAR(40) COMMENT '状态',
   EXECUTE_TIMES_       INT COMMENT '执行次数',
   MAX_ATTEMPTS_        INT COMMENT '重试次数',
   DELAY_               CHAR(10) COMMENT '重试时间间隔',
   MULTIPLIER_          DECIMAL(14,2) COMMENT '延迟倍率_',
   DELETED_             INT DEFAULT 0 COMMENT '逻辑删除',
   COMPANY_ID_          VARCHAR(30) COMMENT '公司ID',
   CREATE_DEP_ID_       VARCHAR(64) COMMENT '创建部门ID',
   TENANT_ID_           VARCHAR(64) COMMENT '租户ID',
...
ALTER TABLE SYS_HTTP_TASK COMMENT '接口调用表';
...
(
   ...
   RESULT_              VARCHAR(40) COMMENT '日志结果',
...
ALTER TABLE SYS_HTTP_TASK_LOG COMMENT '接口调用日志表';
...
(
   ...
   INST_CONFIG_         TEXT COMMENT '机构个性化配置',
   DELETED_             INT DEFAULT 0 COMMENT '逻辑删除',
   COMPANY_ID_          VARCHAR(30) COMMENT '公司ID',
   TENANT_ID_           VARCHAR(64) COMMENT '租用用户Id',
   CREATE_DEP_ID_       VARCHAR(64) COMMENT '创建部门ID',
...
(
   ...
   STATUS_              VARCHAR(20) COMMENT '状态',
   IS_LOG_              VARCHAR(10) NOT NULL COMMENT '是否记录日志',
   DELETED_             INT DEFAULT 0 COMMENT '逻辑删除',
   COMPANY_ID_          VARCHAR(30) COMMENT '公司ID',
   TENANT_ID_           VARCHAR(64) COMMENT '租用用户Id',
   CREATE_DEP_ID_       VARCHAR(64) COMMENT '创建部门ID',
