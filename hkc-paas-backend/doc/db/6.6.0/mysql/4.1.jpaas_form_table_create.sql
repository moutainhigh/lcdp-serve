...
(
   ...
   BO_ATTR_TEMP_        LONGTEXT COMMENT '暂存的实体属性',
   IS_TENANT_           VARCHAR(20) COMMENT '是否为租户使用',
   DELETED_             INT DEFAULT 0 COMMENT '逻辑删除',
   COMPANY_ID_          VARCHAR(30) COMMENT '公司ID',
   TENANT_ID_           VARCHAR(64) COMMENT '租户ID',
   CREATE_DEP_ID_       VARCHAR(64) COMMENT '创建部门ID',
...
(
   ...
   IS_TREE_DLG_         VARCHAR(10) NOT NULL COMMENT '是否树对话框',
   DB_AS_               VARCHAR(64) COMMENT '数据源ID',
   IS_DIALOG_           VARCHAR(10) NOT NULL COMMENT '是否对话框',
   IS_GEN_              VARCHAR(10) COMMENT '是否已产生HTML',
   TREE_ID_             VARCHAR(64) COMMENT '分类ID',
   MOBILE_HTML_         TEXT COMMENT '移动端HTML',
   LIST_HTML_           TEXT COMMENT '列表生成的HTML',
   EXT_JSON_            LONGTEXT COMMENT '列表配置信息',
   DELETED_             INT DEFAULT 0 COMMENT '逻辑删除',
   COMPANY_ID_          VARCHAR(30) COMMENT '公司ID',
   TENANT_ID_           VARCHAR(64) COMMENT '租户ID',
...
(
   ...
   MOBILE_CONTENT_      TEXT COMMENT '移动端内容',
...
(
   ...
   BO_ALIAS_            VARCHAR(64) COMMENT 'BO实体别名',
   BO_NAME_             VARCHAR(64) COMMENT 'BO实体名称',
   SQL_                 VARCHAR(4000) COMMENT 'SQL语句',
...
ALTER TABLE FORM_CHANGE_LOG COMMENT '表单变更记录';
...
(
   ...
   KEY_                 VARCHAR(64) COMMENT '别名',
   DESCP_               VARCHAR(255) COMMENT '描述',
   SETTING_JSON_        LONGTEXT COMMENT '生成代码配置信息',
   TREE_ID_             VARCHAR(64) COMMENT '分类ID',
   DELETED_             INT DEFAULT 0 COMMENT '逻辑删除',
   COMPANY_ID_          VARCHAR(30) COMMENT '公司ID',
   TENANT_ID_           VARCHAR(64) COMMENT '租户ID',
...
ALTER TABLE FORM_CODEGEN_SETTING COMMENT '代码生成管理';
...
(
   ...
   PARAMS_              VARCHAR(1000) COMMENT '自定义列表参数',
   PRIMARY KEY (ID_)
);
...
(
   ...
   IS_TENANT_           VARCHAR(10) COMMENT '是否为租户使用',
   TREE_ID_             VARCHAR(64) COMMENT '分类ID',
   DELETED_             INT DEFAULT 0 COMMENT '逻辑删除',
   COMPANY_ID_          VARCHAR(30) COMMENT '公司ID',
   TENANT_ID_           VARCHAR(64) COMMENT '租户ID',
...
ALTER TABLE FORM_DOWNLOAD_RECORD COMMENT 'Excel下载记录(异步)';
...
(
   ...
   SN_                  INT COMMENT '序号',
   PARENT_VALUE_        VARCHAR(64) COMMENT '父内容',
...
(
   ...
   DATA_SHOW_TYPE_      VARCHAR(20) COMMENT '展示方式',
...
(
   ...
   TABLE_NAME_          VARCHAR(64) COMMENT '表名',
   RELATION_CONFIG_     TEXT COMMENT '关联配置',
   PROMPT_FIELD_        VARCHAR(64) COMMENT '提示字段',
   DELETED_             INT DEFAULT 0 COMMENT '逻辑删除',
   COMPANY_ID_          VARCHAR(30) COMMENT '公司ID',
   TENANT_ID_           VARCHAR(64) COMMENT '租户ID',
   CREATE_DEP_ID_       VARCHAR(64) COMMENT '部门ID',
...
ALTER TABLE FORM_ENT_RELATION COMMENT '数据关联删除约束';
...
(
   ...
   GEN_STATUS_          VARCHAR(20) NOT NULL COMMENT '生成状态(0为失败、1为成功、2为正在生成)',
   REMARK_              VARCHAR(255) COMMENT '备注',
   CREATE_BY_NAME_      VARCHAR(64) COMMENT '创建人名称',
   DELETED_             INT DEFAULT 0 COMMENT '逻辑删除',
   COMPANY_ID_          VARCHAR(30) COMMENT '公司ID',
...
ALTER TABLE FORM_EXCEL_GEN_TASK COMMENT 'Excel生成任务';
...
(
   ID_                  VARCHAR(64) NOT NULL COMMENT '主键',
   CHANGE_LOG_ID_       VARCHAR(64) COMMENT '表单变更记录ID',
   DATASOURCE_          VARCHAR(64) COMMENT '数据源别名',
   SQL_                 VARCHAR(4000) COMMENT '执行的SQL语句',
   STATUS_              VARCHAR(10) NOT NULL COMMENT '状态(1:成功 0:失败 -1:忽略)',
   RECORD_              TEXT COMMENT '记录',
   BATCH_               VARCHAR(64) COMMENT '批次',
   DELETED_             INT DEFAULT 0 COMMENT '逻辑删除',
   COMPANY_ID_          VARCHAR(30) COMMENT '公司ID',
   TENANT_ID_           VARCHAR(64) COMMENT '租户ID',
   CREATE_DEP_ID_       VARCHAR(64) COMMENT '创建部门ID',
...
ALTER TABLE FORM_EXECUTE_LOG COMMENT '租户数据源执行记录';
...
(
   ...
   FORM_HTML_           LONGTEXT COMMENT '表单HTML',
   SCRIPT_              TEXT COMMENT '表单脚本',
   DEPLOYED_            INT COMMENT '是否发布',
   METADATA_            LONGTEXT COMMENT '元数据',
...
(
   ...
   METADATA_            LONGTEXT COMMENT '表单数据',
   ...
   TEMPLATE_TEMP_       TEXT COMMENT '模版(临时)',
   JAVASCRIPT_TEMP_     TEXT COMMENT '表单脚本（临时）',
   METADATA_TEMP_       LONGTEXT COMMENT '表单数据(临时)',
...
(
   ...
   FORM_ALIAS_          VARCHAR(40) COMMENT '表单别名',
   BO_ALIAS_            VARCHAR(40) COMMENT 'BO定义别名',
...
(
   ...
   VIEW_TYPE_           VARCHAR(40) NOT NULL COMMENT '视图类型',
   DEFAULT_VIEW_        VARCHAR(40) COMMENT '是否默认',
   LIST_ID_             VARCHAR(64) COMMENT '列表ID',
   DELETED_             INT DEFAULT 0 COMMENT '逻辑删除',
   COMPANY_ID_          VARCHAR(30) COMMENT '公司ID',
   TENANT_ID_           VARCHAR(64) COMMENT '租户ID',
...
(
   ...
   CATEGORY_            VARCHAR(64) COMMENT '分类',
   FILE_NAME_           VARCHAR(128) COMMENT '文件名称',
   PATH_                VARCHAR(128) COMMENT '文件路径',
   SINGLE_              VARCHAR(40) COMMENT '生成单个文件',
   GEN_MODE_            VARCHAR(40) COMMENT '实体生成类型',
   MAIN_SUB_TYPE_       VARCHAR(64) COMMENT '模式',
   DELETED_             INT DEFAULT 0 COMMENT '逻辑删除',
   COMPANY_ID_          VARCHAR(30) COMMENT '公司ID',
   TENANT_ID_           VARCHAR(64) COMMENT '租户ID',
   CREATE_DEP_ID_       VARCHAR(64) COMMENT '创建部门ID',
