...
(
   REC_ID_              VARCHAR(64) NOT NULL COMMENT '主键',
...
(
   ...
   APP_                 VARCHAR(64) COMMENT '内部应用',
   APP_TYPE_            VARCHAR(64) COMMENT '应用类型(DEFAULT、CUSTOM)',
   DELETED_             INT DEFAULT 0 COMMENT '逻辑删除',
   COMPANY_ID_          VARCHAR(30) COMMENT '公司ID',
   TENANT_ID_           VARCHAR(64) COMMENT '租用机构ID',
   CREATE_DEP_ID_       VARCHAR(64) COMMENT '创建人部门ID',
...
(
   ID_                  VARCHAR(64) NOT NULL COMMENT '主键',
   SN_                  INT COMMENT '序号',
   MSG_ID_              VARCHAR(64) COMMENT '消息定义',
   BOX_ID_              VARCHAR(64) COMMENT '盒子定义',
   APP_ID_              VARCHAR(64) COMMENT '应用ID',
   DELETED_             INT DEFAULT 0 COMMENT '逻辑删除',
   COMPANY_ID_          VARCHAR(30) COMMENT '公司ID',
   TENANT_ID_           VARCHAR(64) COMMENT '租用用户Id',
...
ALTER TABLE INS_MSGBOX_BOX_DEF COMMENT '消息盒子关系';
