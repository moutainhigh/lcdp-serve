...
ALTER TABLE OS_GRADE_ADMIN COMMENT '分级管理员表';
...
(
    ...
    API_PATH_            VARCHAR(100) COMMENT 'API 路径',
    API_METHOD_          VARCHAR(64) COMMENT 'HTTP方法',
    SERVICE_             VARCHAR(64) COMMENT '微服务名称',
    PRIMARY KEY (ID_)
);

ALTER TABLE OS_GROUP_API COMMENT '用户组API';
