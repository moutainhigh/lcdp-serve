...
import com.redxun.gateway.utils.XssCleanRuleUtils;
...
public class XssRequestGlobalFilter implements GlobalFilter, Ordered {
    ...
    public Mono<Void> filter(ServerWebExchange exchange, GatewayFilterChain chain){
        ...
        return handXss(exchange,chain,reqUrl);
    }
    ...
    private Mono<Void> handXss(ServerWebExchange exchange,GatewayFilterChain chain,String reqUrl)throws Exception{
        ServerHttpRequest serverHttpRequest = exchange.getRequest();
        ...
        //post请求时，如果是文件上传之类的请求，不修改请求消息体
            ...
            int length = bodyStr.getBytes("utf-8").length;
    ...
    private DataBuffer stringBuffer(String value) {
        ...
        String aa=new String(bytes, Charset.forName("utf-8"));
