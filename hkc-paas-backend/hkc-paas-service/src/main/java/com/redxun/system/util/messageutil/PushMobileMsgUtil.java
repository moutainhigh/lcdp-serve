package com.redxun.system.util.messageutil;
...
public class PushMobileMsgUtil {
	...
	public static void pushMsgToUser(String userList, String title, String text, String body) throws Exception {
		...
		JSONArray list = JSONArray.parseArray(JSONArray.toJSONString(cidList));
		BpmClient bpmClient =  SpringUtil.getBean(BpmClient.class);
		JSONObject bycidList = bpmClient.getBycidList(list);
		Map<String, Object> cidMobileTypeMap = bycidList.getObject("cidMobileTypeMap",	HashMap.class);
