...
public interface SecurityConstants {
    ...
    String CODE_TOKEN_URL = "/oauth/code/token";
     ...
     * 获取登录配置
     */
    String LOGIN_CONFIG_URL = "/validata/getLoginConfig";

    /**
     * 是否显示验证码
     */
    String DEFAULT_VALIDATE_CODE_CONFIG_PREFIX = "/validata/getValidCodeConfig";
    ...
    String OAUTH_CURRENT_USER_URL = "/oauth/user/current";
    /**
     * 根据token获取用户对象登陆
     */
    String PASSWORD_LOGIN_PRO_AUTHORIZE= "/oauth/user/authorize";
    /**
     * PASSWORD模式登录处理地址
     */
     ...
     * PASSWORD模式登录处理地址
     */
    String DD_REGISTER_PRO_URL = "/oauth/user/ddRegister";
    /**
     * PASSWORD模式登录处理地址(手机号)
     */
    String PASSWORD_LOGIN_MOBILE_PRO_URL = "/oauth/user/mobile/token";
    /**
     * 获取授权码地址
     */
     ...
     * redis中当前机构的ID
     */
    String REDIS_TENANT_ID_AUTH = "tenantId_auth:";
     ...
     * 重置密码
     */
    String PASSWORD_RESET = "/oauth/user/resetPassword";
}
