...
@Slf4j
@Component
public class CreateExecutorCalc<E extends BaseEntity<? extends Serializable>> implements IConvertHandler {
    @Override
    ...
    @Override
    public JSONObject handEntityToJsonData(BaseEntity result, String formAlias,
                                           String pack,String genMode) {
        ...
        formData.put("initData",aliaFormJson.getJSONObject("initData"));
        return  formData;
    }
    ...
    public BaseEntity<? extends Serializable> handJsonToEntity(JSONObject formData, BaseEntity entity,
        ...
        try {
            ...
            while(iterator.hasNext()){
                ...
                JSONObject ent = entityJson.getJSONObject(key);
                IFieldHndler control = IFieldContext.getByType(ent.getString("ctr"));
                control.handJsonToEntity(entity,tableJsonList,ent,formData,key,getCreateType());
            }
        }catch (Exception e){
