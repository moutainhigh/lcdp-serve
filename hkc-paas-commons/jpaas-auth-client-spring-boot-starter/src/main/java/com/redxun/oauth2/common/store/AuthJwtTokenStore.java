package com.redxun.oauth2.common.store;

import com.redxun.common.dto.JpaasUserDto;
import com.redxun.oauth2.common.converter.CustomUserAuthenticationConverter;
...
public class AuthJwtTokenStore {
    ...
    public TokenEnhancer tokenEnhancer() {
        return (accessToken, authentication) -> {
            ...
            //增加id参数
            if (principal instanceof JpaasUserDto) {
                JpaasUserDto user = (JpaasUserDto)principal;
