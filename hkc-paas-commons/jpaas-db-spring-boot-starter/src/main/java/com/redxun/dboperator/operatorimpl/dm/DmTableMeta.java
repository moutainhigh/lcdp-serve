...
public class DmTableMeta extends BaseTableMeta {
	...
	private List<Column> getColumnsByTableName(String tableName) {
		...
		List<Column> columnList = jdbcTemplate.query(sql,  new DmColumnMap());
		return columnList;
	}
	...
	protected Map<String, List<Column>> getColumnsByTableName( List<String> tableNames) {
		...
		List<Column> columnModels = jdbcTemplate.query(sql, new DmColumnMap());
